...
Phần này **chỉ mở khi người phụ trách phát ground truth cho Easy, Medium và Hard**, dự kiến trong 60 phút cuối của buổi lab. Trước thời điểm đó, hãy tự vẽ, Save, export và kiểm bằng mắt/`inspect_submissions.py`; repo học viên không chứa đáp án. Chạy scorer là một vòng phản hồi để tìm lỗi và sửa, không thay bài gán nhãn hay report. Không có Python hoặc reference đúng cấu trúc thì vẫn nộp được bài cốt lõi; báo coach nếu bạn muốn tham gia phần bonus mà công cụ không chạy.
